const offer = async () => {
    try {
      ...
      const offerContainer = document.querySelector("#offerGrid");
      ...
      offerData.forEach((item) => {
        ...
        offerContainer.appendChild(gridItem);
      });
    } catch (error) {
      console.error("Error fetching or processing offer data:", error);
    }
  };
